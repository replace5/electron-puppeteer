...
class Page extends _EventEmitter2.default {
  ...
  init() {
    ...
    return _asyncToGenerator(function* () {
      yield _this.build();
      _this._mainFrame = new _Frame2.default(_this, _this.webview, {
        UUID: "~",
        routingId: _this._webContentsId,
        isMainFrame: true
      });
    })();
  }
  ...
  // 监听ipc事件
  _bindIPCEvent() {
    this._prxoyIPCEvent("page.title", "title-updated")._prxoyIPCEvent("page.favicon", "favicon-updated");
  ...
  bringToFront() {
    ...
    return _asyncToGenerator(function* () {
      if (!_this2.isFront) {
        _this2._browser._bringPageToFront(_this2.id);
      }
      return _this2;
    })();
  }
